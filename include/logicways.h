...
// template <typename MoneyType, typename SymbolType, int Height,
//           class SymbolBlockT, typename GameCfgT>
// bool _countFullWays5_wild_Left(
//     ::natashapb::SpinResult& sr, int y0, const SymbolBlockT& arr,
//     const Paytables<5, SymbolType, int, MoneyType>& paytables, MoneyType bet)
//     {
//   typedef GameResultInfo<MoneyType, SymbolType, int, NullType>
//   GameResultInfoT; typedef Paytables<5, SymbolType, int, MoneyType>
//   PaytablesT;
...
//                     curgri->add_lstsymbol(s);
//                     curgri->add_lstsymbol(
//                         getSymbolBlock<SymbolBlockT, 5, Height>(&arr, 1,
//                         y1));
//                     curgri->add_lstsymbol(
//                         getSymbolBlock<SymbolBlockT, 5, Height>(&arr, 2,
//                         y2));
//                     curgri->add_lstsymbol(
//                         getSymbolBlock<SymbolBlockT, 5, Height>(&arr, 3,
//                         y3));
//                     curgri->add_lstsymbol(
//                         getSymbolBlock<SymbolBlockT, 5, Height>(&arr, 4,
//                         y4));
//                   }  // if s[5] can payout
//                 }    // if s5 == s
//               }      // for y4
...
void countFullWays5_Left(
  ...
  for (int i = 0; i < Height; ++i) {
    auto curs = getSymbolBlock<SymbolBlockT, 5, Height>(&arr, 0, i);
    // if (GameCfgT::isWild(curs)) {
    //   _countFullWays5_wild_Left<MoneyType, SymbolType, Height, SymbolBlockT,
    //                             GameCfgT>(sr, curs, i, arr, paytables, bet);
    // } else {
    _countFullWays5_Left<MoneyType, SymbolType, Height, SymbolBlockT, GameCfgT>(
        sr, curs, i, arr, paytables, bet);
    // }
